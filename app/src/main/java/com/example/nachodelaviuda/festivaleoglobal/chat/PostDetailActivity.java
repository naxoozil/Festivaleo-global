...
import com.example.nachodelaviuda.festivaleoglobal.chat.models.Comment;
...
public class PostDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPostReference = FirebaseDatabase.getInstance().getReference()
                .child(Utilidades.nombreSala+"/"+"posts").child(mPostKey);
        mCommentsReference = FirebaseDatabase.getInstance().getReference()
                .child(Utilidades.nombreSala+"/"+"post-comments").child(mPostKey);
    ...
    public void onStart() {
        ...
        ValueEventListener postListener = new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                // [START_EXCLUDE]
                Toast.makeText(PostDetailActivity.this, "Error al subir el post.",
    ...
    private void postComment() {
        ...
        mUsersReference.child("users").child(uid)
        ...
        public CommentAdapter(final Context context, DatabaseReference ref) {
            ...
            ChildEventListener childEventListener = new ChildEventListener() {
                ...
                public void onCancelled(DatabaseError databaseError) {
                    ...
                    Toast.makeText(mContext, "Erros al cargar los comentarios",
                            Toast.LENGTH_SHORT).show();
                }
            };
