...
public class Principal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //db = FirebaseDatabase.getInstance().getReference().getRoot();
        //db = FirebaseDatabase.getInstance().getReference().child("salas");
        ...
        listSala.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                // DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("Chemical Music Festival");
                ...
                //intent.putExtra("display", usu.getDisplayName());
